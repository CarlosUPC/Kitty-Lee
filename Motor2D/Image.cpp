...
Image::Image(int pos_x, int pos_y, const SDL_Rect & image, UIElement * parent, bool inter, bool drag, bool draw)
	: UIElement(IMAGE, pos_x, pos_y, parent, inter, drag, image.w, image.h, draw) {
