...
j1Colliders::j1Colliders() : j1Module()
{
	...
	matrix[COLLIDER_FLOOR][COLLIDER_ENTITY_DOWN] = true;
	...
	matrix[COLLIDER_PLAYER][COLLIDER_ENTITY_DOWN] = false;
	...
	matrix[COLLIDER_ENTITY_DOWN][COLLIDER_FLOOR] = true;
	matrix[COLLIDER_ENTITY_DOWN][COLLIDER_PLATFORM] = true;
	matrix[COLLIDER_ENTITY_DOWN][COLLIDER_PLAYER] = false;
	matrix[COLLIDER_ENTITY_DOWN][COLLIDER_ENTITY_DOWN] = false;
	matrix[COLLIDER_ENTITY_DOWN][COLLIDER_PLAYER_LEFT] = false;
	matrix[COLLIDER_ENTITY_DOWN][COLLIDER_PLAYER_RIGHT] = false;
	matrix[COLLIDER_ENTITY_DOWN][COLLIDER_PLAYER_UP] = false;
	matrix[COLLIDER_ENTITY_DOWN][COLLIDER_DEATH] = false;
	matrix[COLLIDER_ENTITY_DOWN][COLLIDER_SCENE] = false;
	matrix[COLLIDER_ENTITY_DOWN][COLLIDER_GHOST] = false;
	matrix[COLLIDER_ENTITY_DOWN][COLLIDER_WIN] = false;
	matrix[COLLIDER_ENTITY_DOWN][COLLIDER_ENEMY] = false;
	matrix[COLLIDER_ENTITY_DOWN][COLLIDER_COIN] = false;
	...
	matrix[COLLIDER_PLAYER_UP][COLLIDER_ENTITY_DOWN] = false;
	...
	matrix[COLLIDER_PLAYER_UP][COLLIDER_COIN] = false;
	...
	matrix[COLLIDER_PLAYER_LEFT][COLLIDER_ENTITY_DOWN] = false;
	...
	matrix[COLLIDER_PLAYER_LEFT][COLLIDER_COIN] = false;
	...
	matrix[COLLIDER_PLAYER_RIGHT][COLLIDER_ENTITY_DOWN] = false;
	...
	matrix[COLLIDER_PLAYER_RIGHT][COLLIDER_COIN] = false;
	...
	matrix[COLLIDER_DEATH][COLLIDER_ENTITY_DOWN] = false;
	...
	matrix[COLLIDER_SCENE][COLLIDER_ENTITY_DOWN] = false;
	...
	matrix[COLLIDER_SCENE][COLLIDER_COIN] = false;
	...
	matrix[COLLIDER_GHOST][COLLIDER_ENTITY_DOWN] = false;
	...
	matrix[COLLIDER_GHOST][COLLIDER_COIN] = false;
	...
	matrix[COLLIDER_WIN][COLLIDER_ENTITY_DOWN] = false;
	...
	matrix[COLLIDER_ENEMY][COLLIDER_ENTITY_DOWN] = false;
	...
	matrix[COLLIDER_COIN][COLLIDER_PLAYER_UP] = false;
	matrix[COLLIDER_COIN][COLLIDER_ENTITY_DOWN] = false;
	matrix[COLLIDER_COIN][COLLIDER_PLAYER_LEFT] = false;
	matrix[COLLIDER_COIN][COLLIDER_PLAYER_RIGHT] = false;
	matrix[COLLIDER_COIN][COLLIDER_DEATH] = false;
	matrix[COLLIDER_COIN][COLLIDER_GHOST] = false;
	matrix[COLLIDER_COIN][COLLIDER_SCENE] = false;
	...
	if(debug) {
		...
		for (uint i = 0; i < MAX_COLLIDERS; ++i)
		{
			...
			case COLLIDER_PLAYER: // green
				...
				break;
			case COLLIDER_ENTITY_DOWN: // orange
